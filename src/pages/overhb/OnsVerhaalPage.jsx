  ...
  return (
    <main className="ohb-page about">
      <PageHero
        ...
        title="Ons verhaal"
        lead="We verbinden serieuze eventorganisatoren met betrouwbaar hospitality- en beveiligingstalent — zodat elke rij bij de bar, elke deur en elke backstage-overdracht strak loopt, zonder dat uw team uitbrandt op last-minute staffing-gaten."
        stackCtasOnMobile
      >
